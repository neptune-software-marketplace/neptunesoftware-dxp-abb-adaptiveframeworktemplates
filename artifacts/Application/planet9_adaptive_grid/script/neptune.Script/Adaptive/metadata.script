...
const vb = {
    ...
    typeFixed: "{= ${/type} !== 'Icon' && ${/valueType} === 'Fixed' ? true : false }",
    typeFixedIcon: "{= ${/type} === 'Icon' && ${/valueType} === 'Fixed' ? true : false }",
    typeLookup: "{= ${/type} !== 'Icon' && ${/valueType} === 'Lookup' ? true : false }",
    typeRule: "{= ${/type} !== 'Icon' && ${/valueType} === 'Rule' ? true : false }",

    typeObjectTextLayout:
        "{= ${/type} === 'Title' || ${/type} === 'SubTitle' || ${/type} === 'Description' ? true : false }",
    typeObjectAllowIcon: "{= ${/type} === 'Icon' || ${/type} === 'Status' ? true : false }",
    typeObjectNotIcon: "{= ${/type} !== 'Icon' ? true : false }",
    typeObjectStatus: "{= ${/type} === 'Status' ? true : false }",
    ...
    typeObjectStatusIconTypeFixed:
        "{= (${/type} === 'Icon' || ${/type} === 'Status' ) && ${/statusIconType} === 'Fixed' ? true : false }",
    typeObjectStatusIconTypeRule:
        "{= (${/type} === 'Icon' || ${/type} === 'Status') && ${/statusIconType} === 'Rule' ? true : false }",
    typeObjectStatusIconTypeBinding:
        "{= (${/type} === 'Icon' || ${/type} === 'Status') && ${/statusIconType} === 'Binding' ? true : false }",
    typeObjectStatusIconTypeLookup:
        "{= (${/type} === 'Icon' || ${/type} === 'Status') && ${/statusIconType} === 'Lookup'  ? true : false }",
    ...
    typeObjectStatusStateTypeFixed:
        "{= ${/type} === 'Status' && ${/statusStateType} === 'Fixed' ? true : false }",
    typeObjectStatusStateTypeRule:
        "{= ${/type} === 'Status' && ${/statusStateType} === 'Rule'? true : false }",
    typeObjectStatusStateTypeBinding:
        "{= ${/type} === 'Status' && ${/statusStateType} === 'Binding'? true : false }",
    typeObjectStatusStateTypeLookup:
        "{= ${/type} === 'Status' && ${/statusStateType} === 'Lookup'? true : false }",
...
const metadata = {
    properties: {
        ...
        table: {
            ...
            enableCompact: { type: "CheckBox", label: "Compact Mode", default: false },
            enableAction1: { type: "CheckBox", label: "Enable Card Action 1", default: false },
            enableAction2: { type: "CheckBox", label: "Enable Card Action 2", default: false },
            enableAction3: { type: "CheckBox", label: "Enable Card Action 3", default: false },
            enableAction4: { type: "CheckBox", label: "Enable Card Action 4", default: false },
            enableAction5: { type: "CheckBox", label: "Enable Card Action 5", default: false },
    ...
    fieldsRun: {
        ...
        type: {
            type: "SingleSelect",
            label: "Type",
            items: valuesToKeyText(["", "Icon", "Status", "Title", "SubTitle", "Description"]),
        },

        statusLayout: { type: "Title", label: "Layout", visible: vb.typeObjectStatus },
        statusInverted: { type: "CheckBox", label: "Inverted", visible: vb.typeObjectStatus },

        textLayout: { type: "Title", label: "Layout", visible: vb.typeObjectTextLayout },
        // textTitleStyle: {
        //     type: "SingleSelect",
        //     label: "Text Size",
        //     items: valuesToKeyText(["", "H1", "H2", "H3", "H4", "H5", "H6"]),
        //     visible: vb.typeObjectTextLayout,
        // },
        ...
        // Value
        titleValue: { type: "Title", label: "Value", visible: vb.typeObjectNotIcon },
        valueType: {
            type: "SingleSelect",
            label: "Source",
            items: distinctValuesToKeyText([
