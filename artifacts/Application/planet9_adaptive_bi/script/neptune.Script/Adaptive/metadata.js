const vb = {
    ...
    multiSingleSelectScript: "{= ${/type} === 'MultiSelectScript' || ${/type} === 'SingleSelectScript' ? true: false }",
    multiSingleSelectLookup: "{= ${/type} === 'MultiSelectLookup' || ${/type} === 'SingleSelectLookup' ? true: false }",
...
const metadata = {
    ...
    fieldsSel: {
        ...
        titleSelectScript: { type: 'Title', label: 'Data Source', visible: vb.multiSingleSelectScript },
        scriptSelect: { type: 'Script', label: 'Server Script', visible: vb.multiSingleSelectScript },
        ...
        lookupFieldKey: { type: 'TableField', label: 'Key Field', visible: vb.multiSingleSelectLookup },
        lookupFieldText: { type: 'TableField', label: 'Text Field', visible: vb.multiSingleSelectLookup },
        lookupFieldAdditional: { type: 'TableField', label: 'Additional Text Field', visible: vb.multiSingleSelectLookup },
        lookupShowOnlyText: { type: 'CheckBox', label: 'Hide Key Field', visible: vb.multiSingleSelectLookup },
